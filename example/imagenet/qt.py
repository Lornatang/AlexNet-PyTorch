...
parser.add_argument("-a", "--arch", type=str, default='alexnet-e3',
...
if __name__ == "__main__":
    model = AlexNet.from_custom(args.arch, args.resume, num_classes=args.num_classes)
    model.eval()
    if args.image_size is None:
        args.image_size = AlexNet.get_image_size(args.arch)
    # Preprocess image
